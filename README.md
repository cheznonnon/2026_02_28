...
you cannot use MinGW-w64<br>
bunch of errors will happen<br>

## Nonnon Win64

using MinGW-x64 (UCRT) and Windows11<br>
currently, under construction<br>
no compatibility with Win32 Version (rewriting codes entirely)<br>
...
"Nonnon for Mac" repo has the latest binaries.<br>
